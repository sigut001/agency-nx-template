...
/**
 * PIPELINE STEP 02: SEO Generation (Admin SDK Version)
...
const logFile = path.resolve(rootDir, 'debug/seo.log');
...
export async function getRoutes(): Promise<string[]> {
  ...
  log('🚀 Starting SEO Generation / Route Fetching...\n');
...
async function generate() {
  log('🔍 Generating SEO files based on fetched routes...\n');
...
Sitemap: ${projectUrl}/sitemap.xml`;
  ...
  log('✅ SEO files generated successfully!');
}
